...
# --------------------------------------------------------------
power_plants_url = f"https://hub.ag3nts.org/data/{AI_DEVS_API_KEY}/findhim_locations.json"
...
def get_locations(name: str, surname: str) -> list[dict]:
    payload = {"apikey": AI_DEVS_API_KEY, "name": name, "surname": surname}
...
verify_payload = {"apikey": AI_DEVS_API_KEY, "task": "findhim", "answer": verify_answer}
